...
def show_page():
    ...
    " mom, kids, girl, boy, dishes, sink, overflowing water, naughty behavior, stealing cookies, shelf, behind mom, boy falling, stool toppling, sister giggling, laughing, demanding cookies.",   
