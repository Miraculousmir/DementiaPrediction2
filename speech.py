...
def show_page():
    ...
    pic_desc = ["This is a picture featuring a chaotic kitchen scene. The man is busy cutting veggies while the girls are cooking something. The dustbin is smelly and overfilled with waste. The mop and bucket is lying on the floor with water spilled over. The cat is sitting in the midst/middle. There are many items on the table. The water in the pots on the oven is boiling.The kitchen looks in complete disarray",
    ...
    if st.button("Predict"):
        ...
        st.write(f"Probability of having Dementia out of 100: {prob}")
